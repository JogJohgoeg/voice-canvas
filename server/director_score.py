...
def validate(plan):
    ...
    if plan.get('style') not in ['fusion','moyers','vangogh','ink','monet','narrative','world']:raise ValueError('Invalid style')
