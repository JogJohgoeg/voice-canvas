...
> 来源：https://github.com/alswl/guides/blob/master/fe-page-guide-antd.md （作者 Jingchao / alswl，2026-09-12 版）。本仓库所有文档与页面的信息组织以此为设计参考；使用时先回答三问：主信息是什么、需要哪些关联信息与上下文、用户看完要做什么，再选表达骨架。
