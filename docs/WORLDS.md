...
World is an optional preset in the same one-prompt performance page. Try **“Glass Mishima Opening World”**, or **“Glass Mishima Opening World 零AI”** to play through MIDI input without a director request. Add “麦克风” for acoustic input. Drag to look around; scroll for a small dolly movement. The projector and recording use the same world + particle composition.
