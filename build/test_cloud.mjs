...
const world=await worker.fetch(new Request('https://show.test/worlds/index.json',{headers:{Origin:'https://jojtown.github.io'}}),assets);assert.equal(world.headers.get('Access-Control-Allow-Origin'),'https://jojtown.github.io');
